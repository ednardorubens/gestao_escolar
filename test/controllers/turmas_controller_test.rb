...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { ativo: @turma.ativo, codigo: @turma.codigo, nome: @turma.nome } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { ativo: @turma.ativo, codigo: @turma.codigo, nome: @turma.nome } }
