...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { ativo: @disciplina.ativo, codigo: @disciplina.codigo, nome: @disciplina.nome } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { ativo: @disciplina.ativo, codigo: @disciplina.codigo, nome: @disciplina.nome } }
