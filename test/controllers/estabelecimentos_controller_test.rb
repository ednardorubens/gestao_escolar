...
class EstabelecimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estabelecimento" do
    assert_difference('Estabelecimento.count') do
      post estabelecimentos_url, params: { estabelecimento: { ativo: @estabelecimento.ativo, endereco: @estabelecimento.endereco, nome: @estabelecimento.nome } }
    end
  ...
  test "should update estabelecimento" do
    patch estabelecimento_url(@estabelecimento), params: { estabelecimento: { ativo: @estabelecimento.ativo, endereco: @estabelecimento.endereco, nome: @estabelecimento.nome } }
